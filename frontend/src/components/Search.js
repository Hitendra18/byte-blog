...
const Search = ({ className, onSearchKeyword }) => {
  ...
  return (
    <form
      ...
      className={`flex flex-col gap-y-2.5 relative mt-10 ${className}`}
    >
      ...
      <button
        type="submit"
        className="w-full bg-primary text-white font-semibold rounded-lg px-5 py-3 md:absolute md:right-2 md:top-1/2 md:-translate-y-1/2 md:py-2 md:w-fit"
      >
        Search
      </button>
    </form>
