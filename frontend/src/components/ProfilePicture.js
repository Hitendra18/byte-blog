...
const ProfilePicture = ({ avatar }) => {
  ...
  return (
    <>
      ...
      <div className="w-full flex justify-center items-center gap-x-4 mb-10">
        <div className="relative w-20 h-20 rounded-full outline outline-offset-2 outline-primary overflow-hidden">
          <label
